...
export default function AnimatedCrops() {
  return (
    <div style={{
      ...
      <WheatStalk left={9} height={95} delay={0.8} swayClass="crop-sway-alt" />
      <Seedling left={15} height={38} delay={1.0} />
      <WheatStalk left={20} height={90} delay={0.6} swayClass="crop-sway-slow" />
      <Seedling left={26} height={42} delay={0.9} />
      <WheatStalk left={32} height={100} delay={0.7} />
      <Seedling left={38} height={35} delay={1.1} swayClass="crop-sway-slow" />
      <WheatStalk left={44} height={88} delay={0.5} swayClass="crop-sway-alt" />
      <Seedling left={50} height={40} delay={0.8} />
      <WheatStalk left={56} height={95} delay={1.0} />
      <Seedling left={62} height={36} delay={0.6} swayClass="crop-sway" />
      <WheatStalk left={68} height={92} delay={0.9} swayClass="crop-sway-slow" />
      <Seedling left={74} height={44} delay={0.7} />
      <WheatStalk left={80} height={98} delay={0.5} swayClass="crop-sway-alt" />
      <Seedling left={86} height={38} delay={1.0} swayClass="crop-sway-slow" />
